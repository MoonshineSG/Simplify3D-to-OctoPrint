...
def success(message):
	call(["/usr/local/bin/terminal-notifier",  "-message" , str(message), "-title" , "Simplify3D" , "-sender" , "com.Simplify3D.S3D-Software", "-contentImage",  "/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/ToolbarFavoritesIcon.icns"])
...
%s"""%e)
		...
		if os.path.basename(gcode).startswith("_"):
			EDITOR and call([EDITOR, "-w",  gcode])
			trash(gcode)
		else:
